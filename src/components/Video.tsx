    ...
    <div className="flex-1">
      ...
      <div className="p-8 max-w-[1100px] mx-auto">
        ...
        <div className="grid grid-cols-2 gap-8 mt-20">
          <a className="flex items-stretch gap-6 overflow-hidden transition-colors bg-gray-700 rounded hover:bg-gray-600" href="">
            <div className="flex items-center h-full p-6 bg-green-700">
              <FileArrowDown size={40} />
            </div>
            <div className="py-6 leading-relaxed">
              <strong className="text-2xl">Material complementar</strong>
              <p className="mt-2 text-sm text-gray-200">Acesso o material complementar para acelerar o seu desempenho</p>
            </div>
          ...
          <a className="flex items-stretch gap-6 overflow-hidden transition-colors bg-gray-700 rounded hover:bg-gray-600" href="">
            ...
            <div className="py-6 leading-relaxed">
              ...
              <p className="mt-2 text-sm text-gray-200">Baixe wallpapers exclusivos do Ignite Lab e personalize a sua maquina</p>
            </div>
            <div className="flex items-center h-full p-6">
              <CaretRight size={24} />
            </div>
